/* compact [
	...
	page=porte_plume_start.js(lang=ru)
...
,{"name":"{{Полужирный}}","key":"B","className":"outil_bold","replaceWith":function(h){return espace_si_accolade(h,'{{','}}');},"selectionType":"word","dropMenu":[{"id":"miseenevidence","name":"Mettre le texte en [*évidence*]","className":"outil_miseenevidence","openWith":"[*","closeWith":"*]","display":true,"selectionType":"word"}
...
,{"name":"Сделать [ссылкой->http://...]","key":"L","className":"outil_link separateur separateur_apres sepLink","openWith":"[","closeWith":"->[![Укажите адрес для этой ссылки ( вы можете указать в формате URL http://www.monsite.com или просто написать номер статьи).]!]]"}
,{"name":"Сдлать [[сноску]]","className":"outil_notes","openWith":"[[","closeWith":"]]","selectionType":"word"}
...
,{"name":"<quote>Цитата</quote>","key":"Q","className":"outil_quote separateur separateur_apres sepGuillemets","openWith":"\n<quote>","closeWith":"</quote>\n","selectionType":"word","dropMenu":[{"id":"barre_poesie","name":"Форматирование для <poesie>поэзии</poesie>","className":"outil_barre_poesie","openWith":"\n<poesie>","closeWith":"</poesie>\n","display":true,"selectionType":"line"}
]
}
...
,{"name":"Выделение для программного кода (code)","className":"outil_code separateur separateur_apres sepCode","openWith":"<code>","closeWith":"</code>","dropMenu":[{"id":"cadre","name":"Вставить форматированный текст (cadre)","className":"outil_cadre","openWith":"<cadre>\n","closeWith":"\n</cadre>","display":true}
]
}
]
}
...
options={
previewParserPath:"index.php?action=porte_plume_previsu",textEditer:"Редактировать",
...
paddToggle("input#recherche","Поиск");
jQuery("div.search form").click(function(){
jQuery("input#recherche").focus();
});
paddToggle("input#nom_site","form prop nom site");
paddToggle("input#url_site","URL сайта");
paddToggle("textarea#description_site","Описание/комментарий");
...
paddToggle("input.sujet_message_auteur","Тема");
